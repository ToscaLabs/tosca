...
pub(crate) struct Mqtt {
    pub(crate) client: Mutex<
        CriticalSectionRawMutex,
        Client<'static, TcpSocket<'static>, AllocBuffer, 1, 1, 1, 1>,
    >,
}
...
impl Mqtt {
    ...
    pub(crate) fn new() -> Self {
        ...
        let client = Client::<_, _, _, 1, 1, 1>::new(buffer);
    ...
    #[inline]
    pub(crate) async fn publish(&mut self, payload: &[u8]) -> Result<(), Error> {
        /*let Err(e) = self
            .client
            .lock()
            .await
